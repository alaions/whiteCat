...
CREATE TABLE `comment`  (
  ...
  `child_floor` int NOT NULL DEFAULT 0,
  `support_count` int NOT NULL DEFAULT 0,
  `criticism_count` int NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `notification` VALUES (50, 99, 1, 2, 0, '评论点赞通知', '123于Sun Nov 20 22:39:52 CST 2022点赞了你在文章\'java\'下发表的评论：\'\'', '2022-11-20 14:39:52', 1, 47);
...
INSERT INTO `notification` VALUES (53, 99, 1, 2, 0, '评论取消点赞通知', '123于Sun Nov 20 22:45:30 CST 2022取消了你在文章\'java\'下发表的评论：\'6666666\'的赞', '2022-11-20 14:45:30', 1, 1);
...
INSERT INTO `notification` VALUES (62, 99, 1, 2, 0, '评论点赞通知', '123于Sun Nov 20 23:08:12 CST 2022点赞了你在文章\'python\'下发表的评论：\'强强强强\'', '2022-11-20 15:08:13', 2, 55);
INSERT INTO `notification` VALUES (63, 99, 1, 2, 0, '评论取消点赞通知', '123于Sun Nov 20 23:08:14 CST 2022取消了你在文章\'python\'下发表的评论：\'强强强强\'的赞', '2022-11-20 15:08:14', 2, 55);
...
INSERT INTO `notification` VALUES (78, 99, 1, 2, 0, '帖子取消点赞通知', '123于Sun Nov 20 23:21:11 CST 2022取消了你的文章<span style=\"color: #0e8c8c\">java</span>的点赞', '2022-11-20 15:21:12', 1, 0);
INSERT INTO `notification` VALUES (79, 99, 1, 2, 0, '帖子点赞通知', '123于Sun Nov 20 23:21:12 CST 2022点赞了你的文章<span style=\"color: #0e8c8c\">java</span>', '2022-11-20 15:21:13', 1, 0);
...
INSERT INTO `notification` VALUES (88, 99, 1, 2, 0, '帖子取消点赞通知', '123于Sun Nov 20 23:27:25 CST 2022取消了对你文章’<span style=\"color: #0e8c8c\">java</span>’的点赞', '2022-11-20 15:27:25', 1, 0);
...
INSERT INTO `notification` VALUES (107, 99, 1, 2, 0, '帖子点赞通知', '123于Mon Nov 21 17:28:28 CST 2022点赞了你的文章‘<span style=\"color: #0e8c8c\">java</span>‘', '2022-11-21 09:28:28', 1, 0);
INSERT INTO `notification` VALUES (108, 99, 1, 2, 0, '帖子取消点赞通知', '123于Mon Nov 21 17:51:29 CST 2022取消了对你文章’<span style=\"color: #0e8c8c\">java</span>’的点赞', '2022-11-21 09:51:29', 1, 0);
...
INSERT INTO `notification` VALUES (111, 99, 1, 2, 0, '帖子点赞通知', '123于Mon Nov 21 18:08:19 CST 2022点赞了你的文章‘<span style=\"color: #0e8c8c\">java</span>‘', '2022-11-21 10:08:19', 1, 0);
...
INSERT INTO `notification` VALUES (125, 1, 1, 2, 0, '帖子点赞通知', 'whiteCat于Thu Nov 24 16:11:05 CST 2022点赞了你的文章‘<span style=\"color: #0e8c8c\">button无边框</span>‘', '2022-11-24 08:11:05', 76, 0);
INSERT INTO `notification` VALUES (126, 1, 1, 2, 0, '帖子取消点赞通知', 'whiteCat于Thu Nov 24 16:11:09 CST 2022取消了对你文章’<span style=\"color: #0e8c8c\">button无边框</span>’的点赞', '2022-11-24 08:11:09', 76, 0);
INSERT INTO `notification` VALUES (127, 1, 1, 2, 0, '帖子点赞通知', 'whiteCat于Thu Nov 24 16:11:10 CST 2022点赞了你的文章‘<span style=\"color: #0e8c8c\">button无边框</span>‘', '2022-11-24 08:11:10', 76, 0);
INSERT INTO `notification` VALUES (128, 1, 1, 2, 0, '帖子取消点赞通知', 'whiteCat于Thu Nov 24 16:11:10 CST 2022取消了对你文章’<span style=\"color: #0e8c8c\">button无边框</span>’的点赞', '2022-11-24 08:11:11', 76, 0);
INSERT INTO `notification` VALUES (129, 1, 1, 2, 0, '帖子点赞通知', 'whiteCat于Thu Nov 24 16:11:15 CST 2022点赞了你的文章‘<span style=\"color: #0e8c8c\">list.remove(index)失败的原因</span>‘', '2022-11-24 08:11:15', 78, 0);
INSERT INTO `notification` VALUES (130, 1, 1, 2, 0, '帖子取消点赞通知', 'whiteCat于Thu Nov 24 16:11:16 CST 2022取消了对你文章’<span style=\"color: #0e8c8c\">list.remove(index)失败的原因</span>’的点赞', '2022-11-24 08:11:17', 78, 0);
INSERT INTO `notification` VALUES (131, 1, 1, 2, 0, '帖子点赞通知', 'whiteCat于Thu Nov 24 16:11:18 CST 2022点赞了你的文章‘<span style=\"color: #0e8c8c\">list.remove(index)失败的原因</span>‘', '2022-11-24 08:11:19', 78, 0);
INSERT INTO `notification` VALUES (132, 1, 1, 2, 0, '帖子取消点赞通知', 'whiteCat于Thu Nov 24 16:11:19 CST 2022取消了对你文章’<span style=\"color: #0e8c8c\">list.remove(index)失败的原因</span>’的点赞', '2022-11-24 08:11:19', 78, 0);
INSERT INTO `notification` VALUES (133, 1, 1, 2, 0, '帖子点赞通知', 'whiteCat于Thu Nov 24 16:11:21 CST 2022点赞了你的文章‘<span style=\"color: #0e8c8c\">button无边框</span>‘', '2022-11-24 08:11:22', 76, 0);
INSERT INTO `notification` VALUES (134, 1, 1, 2, 0, '帖子点赞通知', 'whiteCat于Thu Nov 24 16:11:23 CST 2022点赞了你的文章‘<span style=\"color: #0e8c8c\">list.remove(index)失败的原因</span>‘', '2022-11-24 08:11:24', 78, 0);
INSERT INTO `notification` VALUES (135, 1, 1, 2, 0, '帖子取消点赞通知', 'whiteCat于Thu Nov 24 16:11:28 CST 2022取消了对你文章’<span style=\"color: #0e8c8c\">button无边框</span>’的点赞', '2022-11-24 08:11:29', 76, 0);
INSERT INTO `notification` VALUES (136, 1, 1, 2, 0, '帖子取消点赞通知', 'whiteCat于Thu Nov 24 16:11:30 CST 2022取消了对你文章’<span style=\"color: #0e8c8c\">list.remove(index)失败的原因</span>’的点赞', '2022-11-24 08:11:31', 78, 0);
INSERT INTO `notification` VALUES (137, 1, 1, 2, 0, '帖子点赞通知', 'whiteCat于Thu Nov 24 16:12:38 CST 2022点赞了你的文章‘<span style=\"color: #0e8c8c\">button无边框</span>‘', '2022-11-24 08:12:38', 76, 0);
INSERT INTO `notification` VALUES (138, 1, 1, 2, 0, '帖子点赞通知', 'whiteCat于Thu Nov 24 16:12:40 CST 2022点赞了你的文章‘<span style=\"color: #0e8c8c\">list.remove(index)失败的原因</span>‘', '2022-11-24 08:12:40', 78, 0);
INSERT INTO `notification` VALUES (139, 1, 1, 2, 0, '帖子取消点赞通知', 'whiteCat于Thu Nov 24 16:12:43 CST 2022取消了对你文章’<span style=\"color: #0e8c8c\">button无边框</span>’的点赞', '2022-11-24 08:12:43', 76, 0);
INSERT INTO `notification` VALUES (140, 1, 1, 2, 0, '帖子取消点赞通知', 'whiteCat于Thu Nov 24 16:12:44 CST 2022取消了对你文章’<span style=\"color: #0e8c8c\">list.remove(index)失败的原因</span>’的点赞', '2022-11-24 08:12:45', 78, 0);
INSERT INTO `notification` VALUES (141, 1, 1, 2, 0, '评论点赞通知', 'whiteCat于Thu Nov 24 16:14:12 CST 2022点赞了你在文章\'button无边框\'下发表的评论：‘<span style=\"color: #0e8c8c\">66</span>’', '2022-11-24 08:14:12', 76, 80);
INSERT INTO `notification` VALUES (142, 1, 1, 2, 0, '评论取消点赞通知', 'whiteCat于Thu Nov 24 16:14:13 CST 2022取消了你在文章\'button无边框\'下发表的评论：‘<span style=\"color: #0e8c8c\">66</span>‘的点赞', '2022-11-24 08:14:14', 76, 80);
INSERT INTO `notification` VALUES (143, 1, 1, 2, 0, '帖子点赞通知', 'whiteCat于Thu Nov 24 16:14:40 CST 2022点赞了你的文章‘<span style=\"color: #0e8c8c\">button无边框</span>‘', '2022-11-24 08:14:40', 76, 0);
INSERT INTO `notification` VALUES (144, 1, 1, 2, 0, '帖子取消点赞通知', 'whiteCat于Thu Nov 24 16:14:42 CST 2022取消了对你文章’<span style=\"color: #0e8c8c\">button无边框</span>’的点赞', '2022-11-24 08:14:42', 76, 0);
INSERT INTO `notification` VALUES (145, 1, 1, 2, 0, '帖子点赞通知', 'whiteCat于Thu Nov 24 16:14:43 CST 2022点赞了你的文章‘<span style=\"color: #0e8c8c\">list.remove(index)失败的原因</span>‘', '2022-11-24 08:14:44', 78, 0);
INSERT INTO `notification` VALUES (146, 1, 1, 2, 0, '帖子取消点赞通知', 'whiteCat于Thu Nov 24 16:14:45 CST 2022取消了对你文章’<span style=\"color: #0e8c8c\">list.remove(index)失败的原因</span>’的点赞', '2022-11-24 08:14:45', 78, 0);
INSERT INTO `notification` VALUES (147, 1, 1, 2, 0, '帖子点赞通知', 'whiteCat于Thu Nov 24 16:14:47 CST 2022点赞了你的文章‘<span style=\"color: #0e8c8c\">button无边框</span>‘', '2022-11-24 08:14:47', 76, 0);
INSERT INTO `notification` VALUES (148, 1, 1, 2, 0, '帖子取消点赞通知', 'whiteCat于Thu Nov 24 16:14:49 CST 2022取消了对你文章’<span style=\"color: #0e8c8c\">button无边框</span>’的点赞', '2022-11-24 08:14:50', 76, 0);
INSERT INTO `notification` VALUES (149, 1, 1, 2, 0, '帖子点赞通知', 'whiteCat于Thu Nov 24 16:14:53 CST 2022点赞了你的文章‘<span style=\"color: #0e8c8c\">button无边框</span>‘', '2022-11-24 08:14:54', 76, 0);
INSERT INTO `notification` VALUES (150, 1, 1, 2, 0, '帖子点赞通知', 'whiteCat于Thu Nov 24 16:14:55 CST 2022点赞了你的文章‘<span style=\"color: #0e8c8c\">list.remove(index)失败的原因</span>‘', '2022-11-24 08:14:55', 78, 0);
INSERT INTO `notification` VALUES (151, 99, 1, 4, 0, NULL, '私信test', '2022-11-24 08:24:21', 0, 0);
INSERT INTO `notification` VALUES (152, 99, 1, 4, 0, NULL, '666', '2022-11-24 08:24:25', 0, 0);
...
CREATE TABLE `tag`  (
  ...
  `topic_count` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `user`  (
  ...
  `avatar` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'defaultAvatar.jpg',
  `introduction` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '_utf8mb4\\\'æ­¤ç¨æ·å¾æï¼æ²¡æçä¸èªæä»ç»\\\'',
  `topic_count` int NULL DEFAULT 0,
  `comment_count` int NULL DEFAULT 0,
  `rank_id` int NULL DEFAULT 1,
  `support_count` int NULL DEFAULT 0,
  `rank_level` int NULL DEFAULT 1,
  `sex` int(10) UNSIGNED ZEROFILL NULL DEFAULT 0000000000,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'whiteCat', '123456', '1345305701@qq.com', 'whiteCat.jpg', '此用户很懒，没有留下自我介绍', 12, 1, 1, 2, 1, 0000000001, 8, 0);
...
INSERT INTO `user` VALUES (6, '666', '123456', 'whitecat117@163.com', '1668164368257.jpg', 'hh', 0, 0, 1, 7, 1, 0000000000, 29, 0);
...
INSERT INTO `user` VALUES (99, '123', '123456', '13453057011@qq.com', '1668318538996.jpg', '此用户很懒，没有留下自我介绍', 0, 0, 1, 0, 1, 0000000000, 15, 0);
